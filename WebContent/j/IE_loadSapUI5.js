oApplication = { // Application is an object
		load: function(src, id, libs, resourceroots, bindingSyntax, theme, CacheBuster, callback) {
			...
			// IE 9 or later fix for setTimeout here
			setTimeout(function() { oApplication.loadSAPUI5(src, id, libs, resourceroots, bindingSyntax, theme, CacheBuster, callback); }, 1000);
			//End IE 9 or later fix
		},
